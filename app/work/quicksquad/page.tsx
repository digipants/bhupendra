...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/bhupendra/work/quicksquad/",
    siteName: "DigiPants",
    images: [
      { url: "/bhupendra/work/quicksquad/og.jpg", width: 1200, height: 630 },
    ],
    locale: "en_IN",
    type: "article",
  },
  twitter: {
    ...
    images: ["/bhupendra/work/quicksquad/og.jpg"],
  },
};
      ...
      <Section>
        <Container>
          <div className="rounded-2xl overflow-hidden border border-zinc-200/60 dark:border-zinc-800/60">
            <img
              src="/bhupendra/work/quicksquad/hero.jpg"
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li>
                    <a
                      ...
                      href="/bhupendra/work/quicksquad/bot-flow.jpg"
                    >
                      Bot flow
                    </a>
                  </li>
                  <li>
                    <a
                      className="hover:underline"
                      href="/bhupendra/work/quicksquad/landing-before-after.jpg"
                    >
...
// Place these images in the personal site repo under public/bhupendra/work/quicksquad/
// - og.jpg (1200x630)
// - hero.jpg
// - bot-flow.jpg
