...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/bhupendra/work/zescher/",
    siteName: "DigiPants",
    images: [
      { url: "/bhupendra/work/zescher/og.jpg", width: 1200, height: 630 },
    ],
    locale: "en_IN",
    type: "article",
  },
  twitter: {
    ...
    images: ["/bhupendra/work/zescher/og.jpg"],
  },
};
      ...
      <Section>
        <Container>
          <div className="rounded-2xl overflow-hidden border border-zinc-200/60 dark:border-zinc-800/60">
            <img
              src="/bhupendra/work/zescher/hero.jpg"
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li>
                    <a
                      ...
                      href="/bhupendra/work/zescher/brand-kit.pdf"
                    >
                      Brand kit
                    </a>
                  </li>
                  <li>
                    <a
                      className="hover:underline"
                      href="/bhupendra/work/zescher/storefront.jpg"
                    >
...
// Place these assets in the repo under public/bhupendra/work/zescher/
// - og.jpg (1200x630)
// - hero.jpg
// - brand-kit.pdf
// - storefront.jpg
