...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Shopify launch with Syncee/Zendrop, creative testing, UGC ads, and post‑purchase upsells to improve AOV & LTV.",
    url: "/bhupendra/work/pearlytots/",
    siteName: "DigiPants",
    images: [
      { url: "/bhupendra/work/pearlytots/og.jpg", width: 1200, height: 630 },
    ],
    locale: "en_IN",
    type: "article",
  },
  twitter: {
    ...
    images: ["/bhupendra/work/pearlytots/og.jpg"],
  },
};
      ...
      <Section>
        <Container>
          <div className="rounded-2xl overflow-hidden border border-zinc-200/60 dark:border-zinc-800/60">
            <img
              src="/bhupendra/work/pearlytots/hero.jpg"
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li>
                    <a
                      ...
                      href="/bhupendra/work/pearlytots/creative-grid.jpg"
                    >
                      Creative grid
                    </a>
                  </li>
                  <li>
                    <a
                      className="hover:underline"
                      href="/bhupendra/work/pearlytots/funnel.jpg"
                    >
                      Funnel map
                    </a>
                  </li>
...
// Place these images in the personal site repo under public/bhupendra/work/pearlytots/
// - og.jpg (1200x630)
// - hero.jpg
// - creative-grid.jpg
// - funnel.jpg
