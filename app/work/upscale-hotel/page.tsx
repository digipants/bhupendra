...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Rebuilt the funnel with PMax + Meta remarketing, added parity landing pages, and automated cart‑abandon flows.",
    url: "/bhupendra/work/upscale-hotel/",
    siteName: "DigiPants",
    images: [
      { url: "/bhupendra/work/upscale-hotel/og.jpg", width: 1200, height: 630 },
    ],
    locale: "en_IN",
    type: "article",
  },
  twitter: {
    ...
    images: ["/bhupendra/work/upscale-hotel/og.jpg"],
  },
};
        ...
        <Container>
          <nav className="text-sm text-zinc-600 dark:text-zinc-400 mb-6">
            <ol className="flex items-center gap-2">
              ...
              <li>/</li>
              <li>
                <Link href="/bhupendra/#work" className="hover:underline">
                  Selected Work
                </Link>
              </li>
              <li>/</li>
      ...
      <Section>
        <Container>
          <div className="rounded-2xl overflow-hidden border border-zinc-200/60 dark:border-zinc-800/60">
            <img
              src="/bhupendra/work/upscale-hotel/hero.jpg"
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li>
                    <a
                      ...
                      href="/bhupendra/work/upscale-hotel/parity-page.jpg"
                    >
                      Parity page sample
                    </a>
                  </li>
                  <li>
                    <a
                      className="hover:underline"
                      href="/bhupendra/work/upscale-hotel/funnel.jpg"
                    >
                      Funnel map
                    </a>
                  </li>
...
// Place these images in the personal site repo under public/bhupendra/work/upscale-hotel/
// - og.jpg (1200x630)
// - hero.jpg
// - parity-page.jpg
// - funnel.jpg
