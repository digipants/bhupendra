...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/bhupendra/work/",
    siteName: "DigiPants",
    images: [{ url: "/bhupendra/work/og.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
const projects = [
  {
    ...
    tag: "D2C",
    img: "/bhupendra/work/pearlytots/hero.jpg",
  },
  {
    slug: "upscale-hotel",
    ...
    tag: "Hotels",
    img: "/bhupendra/work/upscale-hotel/hero.jpg",
  },
  {
    slug: "quicksquad",
    ...
    tag: "AI",
    img: "/bhupendra/work/quicksquad/hero.jpg",
  },
  {
    slug: "zescher",
    ...
    tag: "POD",
    img: "/bhupendra/work/zescher/hero.jpg",
  },
];

function Card({ p }: { p: (typeof projects)[number] }) {
  return (
    <Link href={`/bhupendra/work/${p.slug}/`} className="group">
...
// Place a social preview at public/bhupendra/work/og.jpg (1200x630)
